while True:
    ...
    while True:
        ...
        if choice.lower() == 'a':
            ...
            if health > 50:
                print("You died! \nSometimes, it's better to be humble \nYou woke up and realized that it was all a dream.")
            else:
                health += 20
                print("The figure senses your weakness and offers you a healing potion! and to become his apprentice. \nWhile on your journey a bright light suddenly appears and you woke up from your dream!")
            break
        elif choice.lower() == 'v':
            print("You decide to avoid the mysterious figure. \nA bright light suddenly appears and you woke up from your dream!")
            break
        else:
            print("Invalid choice.")

    play_again = input("\nDo you want to sleep again? (yes/no): ").lower()
    if play_again != "yes":
